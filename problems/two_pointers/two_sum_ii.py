...
Difficulty: Medium
Source: LeetCode #167 (Meta Interview Question)
...
Hints:
- The array is sorted - use this to your advantage
- Two pointers: one at start, one at end
- If sum too big, move right pointer left. If sum too small, move left pointer right.
"""
